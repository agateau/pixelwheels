...
public class JsonGameStatsImplIOTests {
    ...
    public void testIO() {
        ...
        addResult(stats, 14);
        addResult(stats, 10);
        gameStats.onChampionshipFinished(Difficulty.PRO, ch1, 1);
        gameStats.onChampionshipFinished(Difficulty.CASUAL, ch2, 2);
        ...
        assertThat(gameStats2.getBestChampionshipRank(Difficulty.PRO, ch1), is(1));
        assertThat(gameStats2.getBestChampionshipRank(Difficulty.CASUAL, ch2), is(2));
