...
public class DebugScreen extends PwStageScreen {
    ...
    private void setupUi() {
        ...
        addRange("Max driving force (Casual)", "casualMaxDrivingForce", 10, 200, 10);
        addRange("Max driving force (Pro)", "proMaxDrivingForce", 10, 200, 10);
        addRange("Max driving force (Legen.)", "legendaryMaxDrivingForce", 10, 200, 10);
